...
describe('Central de Antendimento ao Cliente TAT', function() {
    ...
    it('seleciona um arquivo utilizando uma fixtre para a qal foi dada um alias', function() {
    ...
    it('preencher a área d texto usando o comando invoke', function () {
      const longText = Cypress._.repeat('TEST TEST TEST TEST TEST TEST', 20)
